...
<svg fill="#000000" viewBox="0 0 24 24" id="dashboard" data-name="Flat Line" xmlns="http://www.w3.org/2000/svg"width="30"
    ...
    <g id="SVGRepo_iconCarrier">
        <path id="secondary"
            ...
            style="fill: #FDFEC2; stroke-width:1.224;"></path>
        <path id="primary"
            ...
            style="fill: none; stroke: #000000; stroke-linecap: round; stroke-linejoin: round; stroke-width:1.224;">
        </path>
    </g>
</svg>
