<x-guest-layout>
    ...
    <div class="home-page-header px-5 py-5 mb-5 text-center">

        <h1 class="mt-5 display-5 fw-bold text-body-emphasis">AVNL Recruitment</h1>
        <div class="col-lg-6 mx-auto mb-5">
            <p class="home-page-header-description mb-4">Empowering job seekers to find the right job at AVNL, a new Defence PSU with its
            ...
            <div class="d-grid gap-2 d-sm-flex justify-content-sm-center form-search-container">
                <input class="form-control form-search" type="text"
