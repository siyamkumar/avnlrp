<div class="row mt-3 mb-3 g-3 border-bottom pb-3">
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control @error('school_board') is-invalid @enderror " id="school_board"
            name="school_board" value="{{ old('school_board', $secondaryeducationdetail->school_board ?? '') }}" placeholder="Board Name">
            @error('school_board')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="form-control @error('year_of_passing') is-invalid @enderror" id="year_of_passing"
            name="year_of_passing" value="{{ old('year_of_passing', $secondaryeducationdetail->year_of_passing ?? '') }}" placeholder="Year">
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="form-control @error('score') is-invalid @enderror" id="score" name="score" 
            value="{{ old('score', $secondaryeducationdetail->score ?? '') }}" placeholder="% of marks obtained">
            @error('score')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <div class="col-md-4">
        ...
        <input type="file" name="marksheet_path" class="filepond  @error('marksheet_path') is-invalid @enderror"   
                accept="image/*" />
