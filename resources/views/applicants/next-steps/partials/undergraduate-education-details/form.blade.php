<div class="row mt-3 mb-3 g-3 border-bottom pb-3">
    <div class="col-md-4">
        ...
        @error('course_name') is-invalid @enderror" id="course_name" name="course_name"
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="form-control
        @error('college_name') is-invalid @enderror" id="college_name" name="college_name"
            value = "{{ old('college_name', $graduationeducationdetail->college_name ?? '') }}">
        @error('college_name')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="form-control
        @error('year_of_passing') is-invalid @enderror" id="year_of_passing" name="year_of_passing" placeholder=""
            value = "{{ old('year_of_passing', $graduationeducationdetail->year_of_passing ?? '') }}">
    ...
    <div class="col-md-4">
        ...
        <input type="text" class="form-control
         @error('score') is-invalid @enderror
         " id="score" name="score" placeholder="% of marks obtained"
            value = "{{ old('score', $graduationeducationdetail->score ?? '') }}">
        @error('score')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <div class="col-md-4">
        ...
        <input type="file" id="graduateMarksheet" name="graduateMarksheet"
            class="filepond  @error('graduateMarksheet') is-invalid @enderror" />
    </div>
</div>
