...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2023 at 05:45 AM
...
--
-- Table structure for table `age_criterias`
--

CREATE TABLE `age_criterias` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `job_posting_id` bigint(20) UNSIGNED NOT NULL,
  `minAge` smallint(6) DEFAULT NULL,
  `maxAge` smallint(6) DEFAULT NULL,
...
CREATE TABLE `application_reference_numbers` (
  ...
  `shortlist_remarks` varchar(255) DEFAULT NULL,
