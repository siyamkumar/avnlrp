<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="30" class="bi d-block mx-auto mb-1">
    ...
    <g id="SVGRepo_iconCarrier">
        ...
        <path d="M9 13L15 13" stroke="#222222" stroke-width="1.2" stroke-linecap="round"></path>
        <path d="M9 17L13 17" stroke="#222222" stroke-width="1.2" stroke-linecap="round"></path>
        <path d="M13 3V7C13 7.94281 13 8.41421 13.2929 8.70711C13.5858 9 14.0572 9 15 9H19" stroke="#222222"
