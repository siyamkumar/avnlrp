                                        ...
                                        <div class="d-flex align-items-center justify-content-between w-100">
                                            ...
                                            @if ($app->isSubmitted && $app->status == 'submitted')
                                                <div class="">
                                                    ...
                                                    <button class="btn btn-icon btn-success"><svg viewBox="0 0 24 24"
                                                            width="24" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                        ...
                                        <div class="mt-3 pb-3">
                                            ...
                                            <x-card class="">
                                                <div class="">
                                                    ...
                                                    @if ($app->jobpostings->educationcriteria)
                                                        <table class="mt-3">
                                                            <thead>
                                                                <tr>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                @if (in_array('10th', $app->jobpostings->educationcriteria->min_qualification))
                                                                ...
                                                                @if (in_array('12th', $app->jobpostings->educationcriteria->min_qualification))
                                                                    @if ($app->highersecondaryeducationdetails)
                                                                        <tr>
                                                                            <td>
                                                                                12th/Higher Secondary
                                                                            </td>
                                                                ...
                                                                @if (in_array('UG', $app->jobpostings->educationcriteria->min_qualification))


                                                                    @if ($app->graduationeducationdetails)
                                                                        @if (count($app->graduationeducationdetails) > 0)
                                                                ...
                                                                @if (in_array('PG', $app->jobpostings->educationcriteria->min_qualification))
                                                                    @if ($app->postgraduationeducationdetails)
                                                                        @if (count($app->postgraduationeducationdetails) > 0)
                                            ...
                                            <x-card>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <span
                                                            class="fw-bold">{{ $app->candidates->personaldetails->city }}
                                                        </span>
                                                    </div>
                                                    <div class="col-md-4">
