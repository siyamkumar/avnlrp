<div class="row g-3 pb-3 border-bottom">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input type="date" class="form-control  @error('periodFrom') is-invalid @enderror"
                            placeholder="From Date" aria-label="FromDate" id="periodFrom" name="periodFrom"
                            value="{{ old('periodFrom', $experiencedetail->periodFrom ?? '') }}">
                        @error('periodFrom')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <input type="date" class="form-control  @error('periodTo') is-invalid @enderror"
                            placeholder="To Date" aria-label="ToDate" id="periodTo" name="periodTo"
                            value="{{ old('periodTo', $experiencedetail->periodTo ?? '') }}">
                        @error('periodTo')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control  @error('payScale') is-invalid @enderror" id="payScale"
            name="payScale" value="{{ old('payScale', $experiencedetail->payScale ?? '') }}">
        @error('payScale')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <div class="col-md-6">
        ...
        <input class="form-control  @error('experienceFile') is-invalid @enderror" type="file" id="experienceFile"
            name="experienceFile" value="{{ old('experienceFile', $experiencedetail->experienceFile ?? '') }}">
